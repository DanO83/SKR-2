...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_IDLE      150 // (0-255) Idle speed, used when motors are disabled
...
#define EXTRUDER_AUTO_FAN_SPEED 135   // 255 == full speed
